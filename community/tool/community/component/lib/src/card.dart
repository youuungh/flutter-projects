        ...
        child: Column(
          ...
          children: [
                      ...
                      child: Row(
                        children: [
                          ...
                          if (thumbnailUrls.isNotEmpty) ...[
                            ...
                            CommunityThumbnailImage(imageUrls: thumbnailUrls),
                          ],
                        ],
                      ),
                    ),
            ...
            Row(
              children: [
                Expanded(
                  child: CommunityCardButton.like(
                    context,
                    count: likeCount,
                    isSelected: isLike,
                ...
                Expanded(
                  child: CommunityCardButton.view(
                    context,
                    count: viewCount,
...
class CommunityLoadingPostCard extends StatelessWidget {
  const CommunityLoadingPostCard({super.key});
