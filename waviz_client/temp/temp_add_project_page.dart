...
// import 'package:waviz_client/shared/enum/enum_project_class.dart';
// import 'package:waviz_client/shared/model/project_type.dart';
...
//     return Scaffold(
//       appBar: AppBar(title: const Text("프로젝트 정보"), centerTitle: true),
//       body: Padding(
...
//               ),
//               const Gap(12),
//               const Text("최소 50만 원 ~ 최대 1억 원 사이에서 설정해 주세요."),
//               const Gap(12),
//               TextFormField(
...
//                             context,
//                           ).showSnackBar(SnackBar(content: Text("처리 실패")));
//                         }
//                       }
//                     },
//                     height: 50,
