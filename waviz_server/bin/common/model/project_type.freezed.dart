...
mixin _$ProjectType {
 ...
 int? get id; String? get type; String? get created;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ProjectType&&(identical(other.id, id) || other.id == id)&&(identical(other.type, type) || other.type == type)&&(identical(other.created, created) || other.created == created));
}
...
@useResult
$Res call({
 int? id, String? type, String? created
});
...
/// Create a copy of ProjectType
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? type = freezed,Object? created = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  String? type,  String? created)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProjectType() when $default != null:
return $default(_that.id,_that.type,_that.created);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  String? type,  String? created)  $default,) {final _that = this;
switch (_that) {
case _ProjectType():
return $default(_that.id,_that.type,_that.created);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  String? type,  String? created)?  $default,) {final _that = this;
switch (_that) {
case _ProjectType() when $default != null:
return $default(_that.id,_that.type,_that.created);case _:
  return null;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ProjectType&&(identical(other.id, id) || other.id == id)&&(identical(other.type, type) || other.type == type)&&(identical(other.created, created) || other.created == created));
}
...
/// Create a copy of ProjectType
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? type = freezed,Object? created = freezed,}) {
